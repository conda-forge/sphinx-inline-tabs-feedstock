...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-inline-tabs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11476&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-inline-tabs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-inline-tabs` can be installed with:

```
conda install sphinx-inline-tabs
```

It is possible to list all of the versions of `sphinx-inline-tabs` available on your platform with:
